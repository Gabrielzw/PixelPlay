...
class FavoriteFoldersTabView extends StatefulWidget {
  ...
  @override
  State<FavoriteFoldersTabView> createState() => _FavoriteFoldersTabViewState();
}

class _FavoriteFoldersTabViewState extends State<FavoriteFoldersTabView>
  ...
  void _addFolder(String title) {
    ...
    final nextFolder = FavoriteFolderEntry(
      id: 'favorite-folder-${now.microsecondsSinceEpoch}',
      title: title.trim(),
      createdAt: now,
  ...
  void _deleteSelectedFolders() {
    ...
    showFavoritesConfirmationDialog(
      context,
      title: '删除收藏夹',
      content: '确定删除选中的 ${selectedIds.length} 个收藏夹吗？',
      confirmLabel: '删除',
    ).then((bool confirmed) {
